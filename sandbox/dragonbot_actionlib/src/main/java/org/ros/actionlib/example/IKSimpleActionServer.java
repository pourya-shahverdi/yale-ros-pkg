...
/**
 * The IKSimpleActionServer is a specialized DefaultSimpleActionServer
 * that offers services related to the IK action. The
 * IKSimpleActionServer completely hides the Generics approach of the
 ...
 */
public class IKSimpleActionServer
    extends
    DefaultSimpleActionServer<IKActionFeedback, IKActionGoal, IKActionResult, IKFeedback, IKGoal, IKResult> {

  public IKSimpleActionServer(
      String nameSpace,
