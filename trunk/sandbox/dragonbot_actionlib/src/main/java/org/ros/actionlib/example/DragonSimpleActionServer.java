...
/**
 * The DragonSimpleActionServer is a specialized DefaultSimpleActionServer
 * that offers services related to the Dragon action. The
 * DragonSimpleActionServer completely hides the Generics approach of the
 ...
 */
public class DragonSimpleActionServer
    extends
    DefaultSimpleActionServer<DragonActionFeedback, DragonActionGoal, DragonActionResult, DragonFeedback, DragonGoal, DragonResult> {

  public DragonSimpleActionServer(
      String nameSpace,
