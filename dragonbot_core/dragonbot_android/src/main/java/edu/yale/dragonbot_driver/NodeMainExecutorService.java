...
public class NodeMainExecutorService extends Service implements NodeMainExecutor {
  ...
  static final String ACTION_START = "edu.yale.dragonbot_android.ACTION_START_NODE_RUNNER_SERVICE";
  static final String ACTION_SHUTDOWN = "edu.yale.dragonbot_android.ACTION_SHUTDOWN_NODE_RUNNER_SERVICE";
  static final String EXTRA_NOTIFICATION_TITLE = "edu.yale.dragonbot_android.EXTRA_NOTIFICATION_TITLE";
  static final String EXTRA_NOTIFICATION_TICKER = "edu.yale.dragonbot_android.EXTRA_NOTIFICATION_TICKER";
